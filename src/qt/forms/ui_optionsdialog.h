...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        showAdvancedPSUI = new QCheckBox(groupBox);
        showAdvancedPSUI->setObjectName(QStringLiteral("showAdvancedPSUI"));

        verticalLayout_2->addWidget(showAdvancedPSUI);

        lowKeysWarning = new QCheckBox(groupBox);
        lowKeysWarning->setObjectName(QStringLiteral("lowKeysWarning"));

        verticalLayout_2->addWidget(lowKeysWarning);

        privateSendMultiSession = new QCheckBox(groupBox);
        privateSendMultiSession->setObjectName(QStringLiteral("privateSendMultiSession"));

        verticalLayout_2->addWidget(privateSendMultiSession);
        ...
        privateSendRounds = new QSpinBox(tabWallet);
        ...
        verticalLayout_Wallet->addLayout(horizontalLayout_4_Wallet);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        label_2 = new QLabel(tabWallet);
        ...
        privateSendAmount = new QSpinBox(tabWallet);
        ...
        verticalLayout_Wallet->addLayout(horizontalLayout);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Sparks Core after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Sparks Core on system login", 0));
...
#ifndef QT_NO_TOOLTIP
        showAdvancedPSUI->setToolTip(QApplication::translate("OptionsDialog", "Show additional information and buttons for PrivateSend on overview screen.", 0));
#endif // QT_NO_TOOLTIP
        showAdvancedPSUI->setText(QApplication::translate("OptionsDialog", "Enable advanced PrivateSend interface", 0));
#ifndef QT_NO_TOOLTIP
        lowKeysWarning->setToolTip(QApplication::translate("OptionsDialog", "Show warning dialog when PrivateSend detects that wallet has very low number of keys left.", 0));
#endif // QT_NO_TOOLTIP
        lowKeysWarning->setText(QApplication::translate("OptionsDialog", "Warn if PrivateSend is running out of keys", 0));
#ifndef QT_NO_TOOLTIP
        privateSendMultiSession->setToolTip(QApplication::translate("OptionsDialog", "Whether to use experimental PrivateSend mode with multiple mixing sessions per block.<br/>Note: You must use this feature carefully.<br/>Make sure you always have recent wallet (auto)backup in a safe place!", 0));
#endif // QT_NO_TOOLTIP
        privateSendMultiSession->setText(QApplication::translate("OptionsDialog", "Enable PrivateSend &multi-session", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OptionsDialog", "PrivateSend rounds to use", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Sparks to keep anonymized", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabWallet), QApplication::translate("OptionsDialog", "W&allet", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Sparks Core client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Sparks network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Sparks network through a separate SOCKS5 proxy for Tor hidden services.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Sparks Core.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/projects/p/Sparks/", 0));
...
#ifndef QT_NO_TOOLTIP
        thirdPartyTxUrlsLabel->setToolTip(QApplication::translate("OptionsDialog", "Third party URLs (e.g. a block explorer) that appear in the transactions tab as context menu items.<br/>%s in the URL is replaced by transaction hash. Multiple URLs are separated by vertical bar |.", 0));
#endif // QT_NO_TOOLTIP
        thirdPartyTxUrlsLabel->setText(QApplication::translate("OptionsDialog", "Third party transaction URLs", 0));
#ifndef QT_NO_TOOLTIP
        thirdPartyTxUrls->setToolTip(QApplication::translate("OptionsDialog", "Third party URLs (e.g. a block explorer) that appear in the transactions tab as context menu items.<br/>%s in the URL is replaced by transaction hash. Multiple URLs are separated by vertical bar |.", 0));
#endif // QT_NO_TOOLTIP
