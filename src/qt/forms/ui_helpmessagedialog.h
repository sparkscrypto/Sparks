...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->setWindowTitle(QStringLiteral("Sparks Core - Command-line options"));
        ...
        aboutLogo->setMinimumSize(QSize(96, 464));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 630, 201));
