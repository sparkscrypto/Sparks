    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SPK-light"), QVariant("light"));
    ui->theme->addItem(QString("SPK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SPK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SPK-traditional"), QVariant("trad"));
