    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sparks Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sparks Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sparks Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Sparks Core help message to get a list with possible Sparks Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sparks Core client") + " " + networkStyle->getTitleAddText();
