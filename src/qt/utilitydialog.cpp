    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sparks Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sparks Core"));
...
These denominations are 0.01 SPK, 0.1 SPK, 1 SPK and 10 SPK -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://Sparkscoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://Sparkscoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sparks Core is shutting down...") + "<br /><br />" +
