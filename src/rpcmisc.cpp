...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"Sparksaddress\"\n"
            "\nReturn information about the given Sparks address.\n"
            "\nArguments:\n"
            "1. \"Sparksaddress\"     (string, required) The Sparks address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"Sparksaddress\", (string) The Sparks address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"Sparksaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"Sparksaddress\"  (string, required) The Sparks address to use for the signature.\n"
