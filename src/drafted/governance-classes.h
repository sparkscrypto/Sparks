 ...
 *
 *   // network
 *   CSparksNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CSparksNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SparksNetwork
// //   -- signature requirements : Key1(User)
// class CSparksNetworkVariable : public CGovernanceObject
// {
// private:
