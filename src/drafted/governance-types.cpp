...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SparksNetwork") type = SparksNetwork;
    if(strType == "SparksNetworkVariable") type = SparksNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SparksNetwork) s = "SparksNetwork";
    if(type == SparksNetworkVariable) s = "SparksNetworkVariable";
