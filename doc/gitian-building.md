...
git clone https://github.com/Sparkscoin/Sparks
```
...
in the Sparks Core repository under 'Fetch and build inputs' to install sources which require
...
```bash
    ...
    From https://github.com/Sparkscoin/Sparks
...
BTCPATH=/some/root/path/Sparks.git
SIGPATH=/some/root/path/Sparks-detached-sigs.git
...
[Sparks/gitian.sigs](https://github.com/Sparkscoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
