...
Only requiring some minor changes is Sparks.cpp.
...
Changes to Sparks.cpp
----------------------
Sparks.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
